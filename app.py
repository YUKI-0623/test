...
def fetch_live_race_data(date_str, place_code, race_num, place_name):
    ...
    try:
        ...
        for row in rows:
            ...
            # 強化されたジョッキーマップからスコアを算出（デフォルト値は0.75に底上げ）
            j_score = 0.75
